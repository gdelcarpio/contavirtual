...
<!-- 		<div class="row">
		  ...
		  <li role="presentation"><a href="#">Not. Créd.<span class="badge">12</span></a></li>
	...
	<div class="row">
		...
		<div class="col-md-2 text-right">
					<a href="paginas/boleta-crear.html"  class="btn btn-danger crear_documento">
						<i class="fa fa-plus"></i> Nueva Boleta
					</a>					
			</div>	
			...
			<div class="box-content no-padding">
				<table class="table table-striped table-bordered table-hover table-heading no-border-bottom">
					...
					<tbody>
							...
							<tr>
								<td>20/04/2015</td><td>20/04/2015</td>
								<td>factura</td>
								<td>TM-54801</td>
